...
input_file_name = r"test_stdev.csv"
output_file_name = r"rearanged_output.csv"

attribute_column = "Group"
new_order = [106, 33, 65, 15, 94, 96, 59, 60, 9, 13, 50, 67, 27, 63, 17, 14, 110, 68, 93, 80, 30, 23, 73, 62, 109, 69, 5, 108, 25, 0,
             84, 29, 72, 8, 105, 101, 83, 92, 43, 42, 28, 61, 79, 51, 36, 12, 11, 4, 88, 48, 71, 26, 82, 58, 44, 2, 45, 57, 66, 22, 38, 81, 78, 55, 100, 91, 19, 24, 20, 87, 47, 104, 3, 103, 54, 99, 1,
             46, 32, 49, 53, 77, 102, 98, 89, 16, 76, 40, 18, 7, 31, 34, 97, 6, 52, 86, 35, 107, 75, 10]
