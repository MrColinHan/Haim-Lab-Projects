...
fd_val_folder_name = r"fd_val/"  # name of the folder that holds all fd values, slash at the end
fd_buf_folder_name = r"fd_buffer/"
output_name = r"B_NA_single_dominant_AA.csv"
