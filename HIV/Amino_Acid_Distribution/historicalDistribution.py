...
#7. run Forest run!
Input = r"/Users/Han/Documents/Haim Lab(2018 summer)/3.5.19 kr(rm 61 access nums)/2.12.19_B_gp120(Regional)Sequence_PNGs.xlsx" 
Output = r"/Users/Han/Documents/Haim Lab(2018 summer)/3.5.19 kr(rm 61 access nums)/"
OutputName = "3.5 KR_01-09_gug.xlsx"
TabNumber = 3 # tab number in Excel file
PositionRange = [[134, 134], [148, 148], [505, 505], [506, 506]]
