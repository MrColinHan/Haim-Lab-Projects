...
'''
    For HIV Volatility Project:
        ...
        The program divides the input fasta file into multiple fasta files based on :
            ...
            2. (optional)distinct year : if one patient has samples from different years
...
# ==========================================================================================
working_dir = r"/Users/Han/Documents/Haim_Lab(2018_summer)/11.5.19_hiv_volatility/"
#input_file_name = r"small_test_sample.fas"
input_file_name = r"B_longs_completes.fas"
output_folder_name = r"outputs/"  # back slash at the end
...
output_list = []  # final list for output 
...
check_total_count = 0  # store the total count in this varibale, then check it with count_input_total(x)

# x is the input list, split based on patient name OR name-year
def split_name_year(x): 
    global output_list
    global name_list
    global check_total_count
    check_total_count = 0  # reset
